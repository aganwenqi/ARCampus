                                         ...
                                         IVirtualButtonEventHandler
{
    ...
    public virtual void OnButtonPressed(VirtualButtonBehaviour vb)
    {
        ...
        SetVirtualButtonMaterial(m_VirtualButtonPressed,vb);
    ...
    public virtual void OnButtonReleased(VirtualButtonBehaviour vb)
    {
        ...
        SetVirtualButtonMaterial(m_VirtualButtonDefault, vb);
    ...
    {
        //My Set
        foreach (var v in virtualButtonBehaviours)
        {
            if (material != null && v == vb)
            {
                v.GetComponent<MeshRenderer>().sharedMaterial = material;
            }
        }
           
        // Set the Virtual Button material  GuanFang
        /*
        for (int i = 0; i < virtualButtonBehaviours.Length; ++i)
        {
            if (material != null)
